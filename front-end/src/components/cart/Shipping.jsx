...
const Shipping = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(saveShippingInfo({ address, city, district, phoneNo, zipCode, country }));
          ...
          >
            ...
            <div className="mb-3">
              ...
              >
                ...
                {showVietnamInfo && countryCities.map((city, index) => (
            ...
            <div className="mb-3">
              ...
              >
                ...
                {showVietnamInfo && countryDistricts.map((district, index) => (
